...
export { GitHubCopilotCliProvider } from "./github-copilot-cli.ts";
...
import { GitHubCopilotCliProvider } from "./github-copilot-cli.ts";
...
const PROVIDERS = {
  ...
  "github-copilot-cli": () => new GitHubCopilotCliProvider(),
